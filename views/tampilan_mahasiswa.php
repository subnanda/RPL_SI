...
<body>
 <div class="container bgr">
	...
	<li><a href="<?php echo base_url();?>beranda/data" class="container bgr">Beranda</a></li>
	<li><a href="<?php echo base_url();?>pinjam_mhs" class="container bgr">Peminjaman Aset</a></li>
	<li><a href="<?php echo base_url();?>pinjam_mhs/kelas" class="container bgr">Status Peminjaman</a></li>
